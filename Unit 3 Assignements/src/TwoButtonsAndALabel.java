...
public class TwoButtonsAndALabel extends JFrame implements ActionListener {
	...
	//this class starts with 3 attributes. Two are JButton objects for the user to click 
	// and one is a JLabel object which displays some text.
	...
	public static void setup() {
		//initialize your buttons and label here, each JButton and JLabel object has a setText(String) method you can call.
		//Also do anything else that needs to be done before the user clicks anything.
	}
	
	public void buttonClick(JButton chosen) {
		//this method is called whenever the user clicks a button. The parameter is a JButton object, either
		//"left" or "right"
	}
	...
	public void actionPerformed(ActionEvent e) {
		//when a button is clicked, calls your buttonClick method with whichever JButton object was clicked passed as the argument
